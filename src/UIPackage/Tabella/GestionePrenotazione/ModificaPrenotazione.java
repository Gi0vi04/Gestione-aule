...
//        oraInizioCombo = new JComboBox<>(Arrays.copyOfRange(Costanti.ORARI_AMMESSI.toArray(LocalTime[0]), 0, Costanti.ORARI_AMMESSI.size() - 1));
//        oraFineCombo = new JComboBox<>(Costanti.ORARI_AMMESSI.toArray(LocalTime[0]));
//
...
//        for(int i = orarioInizio + step; i < min(Costanti.ORARI_AMMESSI.size(), orarioInizio + max + 1); i += step){
//            oraFineCombo.addItem(Costanti.ORARI_AMMESSI.get(i).toString());
//        }
//
